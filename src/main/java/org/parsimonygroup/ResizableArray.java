...
public class ResizableArray<T> {
	...
	public ResizableArray(int initialCapacity) {
		...
		internalArray = (T[]) new Object[this.initialCapacity];
	}
	 ...
	 */
	public ResizableArray(int initialCapacity, float expansionFactor) {
	 ...
	 */
	public synchronized T addElementRolling(T value) {
		T discarded = internalArray[startIndex];
	...
	public synchronized void contract() {
		T[] tempArray = (T[]) new Object[numElements + 1];
	...
	public synchronized T[] getElements() {
		T[] elementArray = (T[]) new Object[numElements];
	...
	/**
	 * The expansion factor controls the size of a new aray when an array needs
	 ...
	 */
	public synchronized void setElement(int index, T value) {
		if (index < 0) {
